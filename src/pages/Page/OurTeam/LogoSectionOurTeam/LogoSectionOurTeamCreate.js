...
function LogoSectionOurTeamCreate() {
    ...
    onSubmit: async (values) => {
      try {
        ...
        const response = await api.post(
          "/api/user/logoSectionDataOurTeam",
          values
        );
  ...
  const uploadImage = async (file) => {
    ...
    formData.append("folderName", "images/OurTeam_logoSection_pic"); // Set folderName to "service_section_pic"
...
export default LogoSectionOurTeamCreate;
